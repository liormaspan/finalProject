...
var require_undefsafe = __commonJS({
  "../node_modules/undefsafe/lib/undefsafe.js"(exports, module) {
    "use strict";
        ...
        if (key === "*") {
          ...
          for (prop in parent) {
            ...
            if (shallowObj && shallowObj !== res) {
              if (value && shallowObj === value || value === void 0) {
                if (value !== void 0) {
                  return shallowObj;
                }
                res.push(shallowObj);
...
var require_load = __commonJS({
  "../node_modules/nodemon/lib/config/load.js"(exports, module) {
    ...
    function findAppScript() {
      var pkg = existsSync(path.join(process.cwd(), "package.json")) && __require(path.join(process.cwd(), "package.json"));
      if ((!pkg || pkg.main == void 0) && existsSync("./index.js")) {
        return "index.js";
      }
    }
        ...
        loadFile(options2, config, process.cwd(), function(options3) {
          ...
          if (!options3.script && !options3.exec) {
            ...
            if (found) {
              ...
              options3.execArgs = (options3.execArgs || []).concat(
                options3.args.splice(0, n)
              );
...
var require_watch = __commonJS({
  "../node_modules/nodemon/lib/monitor/watch.js"(exports, module) {
    module.exports.watch = watch;
    module.exports.resetWatchers = resetWatchers;
    var debug = require_browser()("nodemon:watch");
    var debugRoot = require_browser()("nodemon");
    var chokidar = require_chokidar();
    var undefsafe = require_undefsafe();
      ...
      const promise = new Promise(function(resolve) {
        ...
        watcher.on("error", function(error) {
          if (error.code === "EINVAL") {
            utils.log.error(
              "Internal watch failed. Likely cause: too many files being watched (perhaps from the root of a drive?\nSee https://github.com/paulmillr/chokidar/issues/229 for details"
            );
          } else {
    ...
    function filterAndRestart(files) {
      ...
      if (files.length) {
        ...
        utils.log.detail(
          "files triggering change check: " + files.map((file) => {
        ...
        utils.log.detail(
          "changes after filters (before/after): " + [files.length, matched.result.length].join("/")
        );
        config.lastStarted = Date.now();
        if (matched.result.length) {
          if (config.options.delay > 0) {
            utils.log.detail("delaying restart for " + config.options.delay + "ms");
            if (debouncedBus === void 0) {
...
var require_tree = __commonJS({
  "../node_modules/pstree.remy/lib/tree.js"(exports, module) {
    var spawn = require_child_process().spawn;
    module.exports = function(rootPid, callback) {
      const pidsOfInterest = /* @__PURE__ */ new Set([parseInt(rootPid, 10)]);
      var output = "";
...
var require_utils4 = __commonJS({
  "../node_modules/pstree.remy/lib/utils.js"(exports, module) {
    var spawn = require_child_process().spawn;
    ...
    function pidsForTree(tree2, pid) {
...
var require_lib = __commonJS({
  "../node_modules/pstree.remy/lib/index.js"(exports, module) {
    var exec = require_child_process().exec;
    ...
    module.exports = function main(pid, callback) {
      ...
      utils.getStat().then(utils.tree).then((tree2) => utils.pidsForTree(tree2, pid)).then(
        (res) => callback(
          null,
          res.map((p) => p.PID)
        )
...
var require_signals = __commonJS({
  "../node_modules/nodemon/lib/monitor/signals.js"(exports, module) {
    module.exports = {
      SIGHUP: 1,
      SIGINT: 2,
      SIGQUIT: 3,
...
var require_run = __commonJS({
  "../node_modules/nodemon/lib/monitor/run.js"(exports, module) {
    var debug = require_browser()("nodemon:run");
    var statSync = require_fs().statSync;
    var utils = require_utils();
    var bus = utils.bus;
    ...
    var restart = null;
    var psTree = require_lib();
    var path = require_path();
    var signals = require_signals();
    var undefsafe = require_undefsafe();
    var osRelease = parseInt(require_os().release().split(".")[0], 10);
      ...
      if (options.stdin) {
        ...
        if (hasStdio) {
          ...
          if (child.stdout) {
            ...
            utils.log.error(
              "nodemon may not work as expected - please consider upgrading to LTS"
            );
          }
        }
    ...
    function waitForSubProcesses(pid, callback) {
      ...
      psTree(pid, (err, pids) => {
        ...
        utils.log.status(
          `still waiting for ${pids.length} sub-process${pids.length > 2 ? "es" : ""} to finish...`
        );
        setTimeout(() => waitForSubProcesses(pid, callback), 1e3);
      });
    }
    function kill(child2, signal, callback) {
      if (!callback) {
        callback = noop;
      }
      if (utils.isWindows) {
        ...
        try {
          const resultBuffer = execSync(
            `wmic process where (ParentProcessId=${child2.pid}) get ProcessId 2> nul`
          );
          const result = resultBuffer.toString().match(/^[0-9]+/m);
          const processId = Array.isArray(result) ? result[0] : child2.pid;
        ...
        psTree(child2.pid, function(err, pids) {
          if (!psTree.hasPS) {
            sig = signals[signal];
          }
          ...
          waitForSubProcesses(child2.pid, () => {
            exec(`kill -${sig} ${child2.pid}`, callback);
          });
        });
      }
    }
    ...
    bus.on("quit", function onQuit(code) {
      ...
      config.run = false;
      if (child) {
        exitTimer = setTimeout(exit, 10 * 1e3);
...
var require_monitor = __commonJS({
  "../node_modules/nodemon/lib/monitor/index.js"(exports, module) {
    module.exports = {
      run: require_run(),
      watch: require_watch().watch
    };
  }
});
...
var require_parse5 = __commonJS({
  "../node_modules/nodemon/lib/cli/parse.js"(exports, module) {
    var fs = require_fs();
    var path = require_path();
    var existsSync = fs.existsSync || path.existsSync;
    module.exports = parse;
    function parse(argv) {
      ...
      var eat = function(i2, args2) {
        if (i2 <= args2.length) {
          return args2.splice(i2 + 1, 1).pop();
        }
      };
...
var require_cli = __commonJS({
  "../node_modules/nodemon/lib/cli/index.js"(exports, module) {
...
var require_help = __commonJS({
  "../node_modules/nodemon/lib/help/index.js"(exports, module) {
    var fs = require_fs();
    var path = require_path();
    var supportsColor = require_browser2();
    module.exports = help;
    var highlight = supportsColor.stdout ? "\x1B[$1m" : "";
    function help(item) {
      if (!item) {
        item = "help";
      } else if (item === true) {
...
var require_spawn = __commonJS({
  "../node_modules/nodemon/lib/spawn.js"(exports, module) {
    var path = require_path();
    var utils = require_utils();
...
var require_nodemon = __commonJS({
  "../node_modules/nodemon/lib/nodemon.js"(exports, module) {
    var debug = require_browser()("nodemon");
    var path = require_path();
    ...
    function nodemon(settings) {
      ...
      const cwd = process.cwd();
      config.load(settings, function(config2) {
        if (!config2.options.dump && !config2.options.execOptions.script && config2.options.execOptions.exec === "node") {
          if (!config2.required) {
        ...
        utils.colours = config2.options.colours;
        utils.log.info(version.pinned);
        const cwd2 = process.cwd();
        if (config2.options.cwd) {
          utils.log.detail("process root: " + cwd2);
        }
        config2.loaded.map((file) => file.replace(cwd2, ".")).forEach((file) => {
          utils.log.detail("reading config " + file);
        });
        if (config2.options.stdin && config2.options.restartable) {
          process.stdin.resume();
          process.stdin.setEncoding("utf8");
          process.stdin.on("data", (data) => {
            const str = data.toString().trim().toLowerCase();
            if (str === config2.options.restartable) {
              bus.emit("restart");
            } else if (data.charCodeAt(0) === 12) {
              console.clear();
            }
          });
        } else if (config2.options.stdin) {
          var ctrlC = false;
          var buffer = "";
        ...
        if (config2.options.restartable) {
          utils.log.info("to restart at any time, enter `" + config2.options.restartable + "`");
        }
        if (!config2.required) {
          const restartSignal = config2.options.signal === "SIGUSR2" ? "SIGHUP" : "SIGUSR2";
          process.on(restartSignal, nodemon.restart);
          utils.bus.on("error", () => {
            utils.log.fail(new Error().stack);
          });
          utils.log.detail((config2.options.restartable ? "or " : "") + "send " + restartSignal + " to " + process.pid + " to restart");
        }
        const ignoring = config2.options.monitor.map(function(rule) {
          if (rule.slice(0, 1) !== "!") {
            return false;
          }
          rule = rule.slice(1);
          ...
          if (rule.startsWith(cwd2)) {
            return rule.replace(cwd2, ".");
          }
          return rule;
        }).filter(Boolean).join(" ");
        if (ignoring)
          utils.log.detail("ignoring: " + ignoring);
        utils.log.info("watching path(s): " + config2.options.monitor.map(function(rule) {
          if (rule.slice(0, 1) !== "!") {
            try {
        ...
        utils.log.info("watching extensions: " + (config2.options.execOptions.ext || "(all)"));
        if (config2.options.dump) {
          utils.log._log("log", "--------------");
          ...
          utils.log._log("log", "cwd: " + cwd2);
          utils.log._log("log", ["OS:", process.platform, process.arch].join(" "));
          utils.log._log("log", "--------------");
          utils.log._log("log", util.inspect(config2, { depth: null }));
          utils.log._log("log", "--------------");
          if (!config2.required) {
            process.exit();
          }
        ...
        config2.run = true;
        if (config2.options.stdout === false) {
        ...
        if (config2.options.events && Object.keys(config2.options.events).length) {
          Object.keys(config2.options.events).forEach(function(key) {
            utils.log.detail("bind " + key + " -> `" + config2.options.events[key] + "`");
            nodemon.on(key, function() {
              if (config2.options && config2.options.events) {
                spawn(
                  config2.options.events[key],
                  config2,
    ...
    nodemon.removeAllListeners = function(event) {
      Object.keys(eventHandlers).filter(function(e) {
        ...
        eventHandlers[event2].forEach(function(handler) {
          bus.removeListener(event2, handler);
          eventHandlers[event2].splice(eventHandlers[event2].indexOf(handler), 1);
        });
      });
      return nodemon;
    };
...
export default require_nodemon();
